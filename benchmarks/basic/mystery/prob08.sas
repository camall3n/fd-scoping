...
-1
2
Atom locale(wonderbread, bavaria)
...
-1
3
Atom locale(cantelope, bavaria)
Atom locale(cantelope, goias)
Atom locale(cantelope, pennsylvania)
end_variable
begin_variable
var6
-1
...
-1
4
Atom locale(tomato, bavaria)
Atom locale(tomato, bosnia)
Atom locale(tomato, goias)
Atom locale(tomato, pennsylvania)
end_variable
begin_variable
var12
-1
...
Atom craves(learning, pork)
Atom craves(learning, rice)
Atom craves(learning, scallop)
Atom craves(learning, tomato)
Atom craves(learning, tuna)
...
Atom craves(rest, scallop)
Atom craves(rest, tomato)
...
Atom harmony(achievement, jupiter)
...
Atom harmony(lubricity, jupiter)
...
Atom harmony(aesthetics, jupiter)
...
Atom craves(anger, rice)
Atom craves(anger, scallop)
Atom craves(anger, tomato)
